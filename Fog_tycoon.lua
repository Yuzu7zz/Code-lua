...
local Window = OrionLib:MakeWindow({Name = "Kyntho !", HidePremium = false,IntroText = "พ่อมึงตาย", SaveConfig = true, ConfigFolder = "OrionTest"})

local Tab = Window:MakeTab({
	Name = "Main",
	Icon = "rbxassetid://126286630463647",
	PremiumOnly = false
})
